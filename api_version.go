...
func (r ApiGetVersionRequest) Execute() (*VersionResp, *http.Response, error) {
...
//  @return VersionResp
func (a *VersionAPIService) GetVersionExecute(r ApiGetVersionRequest) (*VersionResp, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *VersionResp
	)
