...
// checks if the OSSearchEngine type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OSSearchEngine{}

// OSSearchEngine OSSearchEngine defines model of OS search engine TODO(penghui): Load balancer group +X:model:stats;
...
func (o OSSearchEngine) MarshalJSON() ([]byte, error) {
...
func (o OSSearchEngine) ToMap() (map[string]interface{}, error) {
...
type NullableOSSearchEngine struct {
	value *OSSearchEngine
	isSet bool
}

func (v NullableOSSearchEngine) Get() *OSSearchEngine {
	return v.value
}

func (v *NullableOSSearchEngine) Set(val *OSSearchEngine) {
	v.value = val
	v.isSet = true
}

func (v NullableOSSearchEngine) IsSet() bool {
	return v.isSet
}

func (v *NullableOSSearchEngine) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOSSearchEngine(val *OSSearchEngine) *NullableOSSearchEngine {
	return &NullableOSSearchEngine{value: val, isSet: true}
}

func (v NullableOSSearchEngine) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOSSearchEngine) UnmarshalJSON(src []byte) error {
	v.isSet = true
