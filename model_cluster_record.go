...
// checks if the ClusterRecord type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterRecord{}

// ClusterRecord ClusterRecord defines the response content of cluster related API
...
// SetSamples gets a reference to the given []ClusterStat and assigns it to the Samples field.
func (o *ClusterRecord) SetSamples(v []ClusterStat) {
	o.Samples = v
}

func (o ClusterRecord) MarshalJSON() ([]byte, error) {
...
func (o ClusterRecord) ToMap() (map[string]interface{}, error) {
...
type NullableClusterRecord struct {
	value *ClusterRecord
	isSet bool
}

func (v NullableClusterRecord) Get() *ClusterRecord {
	return v.value
}

func (v *NullableClusterRecord) Set(val *ClusterRecord) {
	v.value = val
	v.isSet = true
}

func (v NullableClusterRecord) IsSet() bool {
	return v.isSet
}

func (v *NullableClusterRecord) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClusterRecord(val *ClusterRecord) *NullableClusterRecord {
	return &NullableClusterRecord{value: val, isSet: true}
}

func (v NullableClusterRecord) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClusterRecord) UnmarshalJSON(src []byte) error {
	v.isSet = true
