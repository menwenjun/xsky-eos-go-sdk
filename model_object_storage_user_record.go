...
// checks if the ObjectStorageUserRecord type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ObjectStorageUserRecord{}

// ObjectStorageUserRecord ObjectStorageUserRecord is used to combine ObjectStorageUser and ObjectStorageUserStat
...
// SetSamples gets a reference to the given []ObjectStorageUserStat and assigns it to the Samples field.
func (o *ObjectStorageUserRecord) SetSamples(v []ObjectStorageUserStat) {
	o.Samples = v
}

func (o ObjectStorageUserRecord) MarshalJSON() ([]byte, error) {
...
func (o ObjectStorageUserRecord) ToMap() (map[string]interface{}, error) {
...
type NullableObjectStorageUserRecord struct {
	value *ObjectStorageUserRecord
	isSet bool
}

func (v NullableObjectStorageUserRecord) Get() *ObjectStorageUserRecord {
	return v.value
}

func (v *NullableObjectStorageUserRecord) Set(val *ObjectStorageUserRecord) {
	v.value = val
	v.isSet = true
}

func (v NullableObjectStorageUserRecord) IsSet() bool {
	return v.isSet
}

func (v *NullableObjectStorageUserRecord) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableObjectStorageUserRecord(val *ObjectStorageUserRecord) *NullableObjectStorageUserRecord {
	return &NullableObjectStorageUserRecord{value: val, isSet: true}
}

func (v NullableObjectStorageUserRecord) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableObjectStorageUserRecord) UnmarshalJSON(src []byte) error {
	v.isSet = true
