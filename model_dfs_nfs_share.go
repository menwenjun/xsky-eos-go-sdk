...
// checks if the DfsNFSShare type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DfsNFSShare{}

// DfsNFSShare DfsNFSShare defines model of dfs nfs share
type DfsNFSShare struct {
...
func (o DfsNFSShare) MarshalJSON() ([]byte, error) {
...
func (o DfsNFSShare) ToMap() (map[string]interface{}, error) {
...
type NullableDfsNFSShare struct {
	value *DfsNFSShare
	isSet bool
}

func (v NullableDfsNFSShare) Get() *DfsNFSShare {
	return v.value
}

func (v *NullableDfsNFSShare) Set(val *DfsNFSShare) {
	v.value = val
	v.isSet = true
}

func (v NullableDfsNFSShare) IsSet() bool {
	return v.isSet
}

func (v *NullableDfsNFSShare) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDfsNFSShare(val *DfsNFSShare) *NullableDfsNFSShare {
	return &NullableDfsNFSShare{value: val, isSet: true}
}

func (v NullableDfsNFSShare) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDfsNFSShare) UnmarshalJSON(src []byte) error {
	v.isSet = true
