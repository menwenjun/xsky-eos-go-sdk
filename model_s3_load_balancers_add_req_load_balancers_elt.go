...
// checks if the S3LoadBalancersAddReqLoadBalancersElt type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &S3LoadBalancersAddReqLoadBalancersElt{}

// S3LoadBalancersAddReqLoadBalancersElt struct for S3LoadBalancersAddReqLoadBalancersElt
...
type _S3LoadBalancersAddReqLoadBalancersElt S3LoadBalancersAddReqLoadBalancersElt
...
func NewS3LoadBalancersAddReqLoadBalancersElt(hostId int64, vip string) *S3LoadBalancersAddReqLoadBalancersElt {
	this := S3LoadBalancersAddReqLoadBalancersElt{}
	this.HostId = hostId
	this.Vip = vip
	return &this
}
...
func (o S3LoadBalancersAddReqLoadBalancersElt) MarshalJSON() ([]byte, error) {
...
func (o S3LoadBalancersAddReqLoadBalancersElt) ToMap() (map[string]interface{}, error) {
...
func (o *S3LoadBalancersAddReqLoadBalancersElt) UnmarshalJSON(data []byte) (err error) {
	...
	varS3LoadBalancersAddReqLoadBalancersElt := _S3LoadBalancersAddReqLoadBalancersElt{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varS3LoadBalancersAddReqLoadBalancersElt)

	if err != nil {
		return err
	}

	*o = S3LoadBalancersAddReqLoadBalancersElt(varS3LoadBalancersAddReqLoadBalancersElt)

	return err
}

type NullableS3LoadBalancersAddReqLoadBalancersElt struct {
	value *S3LoadBalancersAddReqLoadBalancersElt
	isSet bool
}

func (v NullableS3LoadBalancersAddReqLoadBalancersElt) Get() *S3LoadBalancersAddReqLoadBalancersElt {
	return v.value
}

func (v *NullableS3LoadBalancersAddReqLoadBalancersElt) Set(val *S3LoadBalancersAddReqLoadBalancersElt) {
	v.value = val
	v.isSet = true
}

func (v NullableS3LoadBalancersAddReqLoadBalancersElt) IsSet() bool {
	return v.isSet
}

func (v *NullableS3LoadBalancersAddReqLoadBalancersElt) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableS3LoadBalancersAddReqLoadBalancersElt(val *S3LoadBalancersAddReqLoadBalancersElt) *NullableS3LoadBalancersAddReqLoadBalancersElt {
	return &NullableS3LoadBalancersAddReqLoadBalancersElt{value: val, isSet: true}
}

func (v NullableS3LoadBalancersAddReqLoadBalancersElt) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableS3LoadBalancersAddReqLoadBalancersElt) UnmarshalJSON(src []byte) error {
	v.isSet = true
