...
// checks if the OsdGroupRecord type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OsdGroupRecord{}

// OsdGroupRecord OsdGroupRecord combine OsdGroup and OsdGroupStat as API response
...
// SetSamples gets a reference to the given []OsdGroupStat and assigns it to the Samples field.
func (o *OsdGroupRecord) SetSamples(v []OsdGroupStat) {
	o.Samples = v
}

func (o OsdGroupRecord) MarshalJSON() ([]byte, error) {
...
func (o OsdGroupRecord) ToMap() (map[string]interface{}, error) {
...
type NullableOsdGroupRecord struct {
	value *OsdGroupRecord
	isSet bool
}

func (v NullableOsdGroupRecord) Get() *OsdGroupRecord {
	return v.value
}

func (v *NullableOsdGroupRecord) Set(val *OsdGroupRecord) {
	v.value = val
	v.isSet = true
}

func (v NullableOsdGroupRecord) IsSet() bool {
	return v.isSet
}

func (v *NullableOsdGroupRecord) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOsdGroupRecord(val *OsdGroupRecord) *NullableOsdGroupRecord {
	return &NullableOsdGroupRecord{value: val, isSet: true}
}

func (v NullableOsdGroupRecord) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOsdGroupRecord) UnmarshalJSON(src []byte) error {
	v.isSet = true
