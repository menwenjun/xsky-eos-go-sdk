...
// checks if the DiskStat type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DiskStat{}

// DiskStat DiskStat defines the basic info of a DiskStat
...
func (o DiskStat) MarshalJSON() ([]byte, error) {
...
func (o DiskStat) ToMap() (map[string]interface{}, error) {
...
type NullableDiskStat struct {
	value *DiskStat
	isSet bool
}

func (v NullableDiskStat) Get() *DiskStat {
	return v.value
}

func (v *NullableDiskStat) Set(val *DiskStat) {
	v.value = val
	v.isSet = true
}

func (v NullableDiskStat) IsSet() bool {
	return v.isSet
}

func (v *NullableDiskStat) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDiskStat(val *DiskStat) *NullableDiskStat {
	return &NullableDiskStat{value: val, isSet: true}
}

func (v NullableDiskStat) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDiskStat) UnmarshalJSON(src []byte) error {
	v.isSet = true
