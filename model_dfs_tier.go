...
// checks if the DfsTier type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DfsTier{}

// DfsTier DfsTier defines model of dfs tier
type DfsTier struct {
...
func (o DfsTier) MarshalJSON() ([]byte, error) {
...
func (o DfsTier) ToMap() (map[string]interface{}, error) {
...
type NullableDfsTier struct {
	value *DfsTier
	isSet bool
}

func (v NullableDfsTier) Get() *DfsTier {
	return v.value
}

func (v *NullableDfsTier) Set(val *DfsTier) {
	v.value = val
	v.isSet = true
}

func (v NullableDfsTier) IsSet() bool {
	return v.isSet
}

func (v *NullableDfsTier) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDfsTier(val *DfsTier) *NullableDfsTier {
	return &NullableDfsTier{value: val, isSet: true}
}

func (v NullableDfsTier) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDfsTier) UnmarshalJSON(src []byte) error {
	v.isSet = true
