...
// checks if the FSLdapUpdateReqInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FSLdapUpdateReqInfo{}

// FSLdapUpdateReqInfo struct for FSLdapUpdateReqInfo
...
type _FSLdapUpdateReqInfo FSLdapUpdateReqInfo
...
func (o FSLdapUpdateReqInfo) MarshalJSON() ([]byte, error) {
...
func (o FSLdapUpdateReqInfo) ToMap() (map[string]interface{}, error) {
...
func (o *FSLdapUpdateReqInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varFSLdapUpdateReqInfo := _FSLdapUpdateReqInfo{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFSLdapUpdateReqInfo)

	if err != nil {
		return err
	}

	*o = FSLdapUpdateReqInfo(varFSLdapUpdateReqInfo)

	return err
}

type NullableFSLdapUpdateReqInfo struct {
	value *FSLdapUpdateReqInfo
	isSet bool
}

func (v NullableFSLdapUpdateReqInfo) Get() *FSLdapUpdateReqInfo {
	return v.value
}

func (v *NullableFSLdapUpdateReqInfo) Set(val *FSLdapUpdateReqInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableFSLdapUpdateReqInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableFSLdapUpdateReqInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFSLdapUpdateReqInfo(val *FSLdapUpdateReqInfo) *NullableFSLdapUpdateReqInfo {
	return &NullableFSLdapUpdateReqInfo{value: val, isSet: true}
}

func (v NullableFSLdapUpdateReqInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFSLdapUpdateReqInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
