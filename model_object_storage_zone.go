...
// checks if the ObjectStorageZone type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ObjectStorageZone{}

// ObjectStorageZone ObjectStorageZone is the model of object_storage_zone
...
func (o ObjectStorageZone) MarshalJSON() ([]byte, error) {
...
func (o ObjectStorageZone) ToMap() (map[string]interface{}, error) {
...
type NullableObjectStorageZone struct {
	value *ObjectStorageZone
	isSet bool
}

func (v NullableObjectStorageZone) Get() *ObjectStorageZone {
	return v.value
}

func (v *NullableObjectStorageZone) Set(val *ObjectStorageZone) {
	v.value = val
	v.isSet = true
}

func (v NullableObjectStorageZone) IsSet() bool {
	return v.isSet
}

func (v *NullableObjectStorageZone) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableObjectStorageZone(val *ObjectStorageZone) *NullableObjectStorageZone {
	return &NullableObjectStorageZone{value: val, isSet: true}
}

func (v NullableObjectStorageZone) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableObjectStorageZone) UnmarshalJSON(src []byte) error {
	v.isSet = true
