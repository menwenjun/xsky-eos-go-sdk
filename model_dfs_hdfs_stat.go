...
// checks if the DfsHdfsStat type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DfsHdfsStat{}

// DfsHdfsStat DfsHdfsStat records dfs hdfs stat info
type DfsHdfsStat struct {
...
func (o DfsHdfsStat) MarshalJSON() ([]byte, error) {
...
func (o DfsHdfsStat) ToMap() (map[string]interface{}, error) {
...
type NullableDfsHdfsStat struct {
	value *DfsHdfsStat
	isSet bool
}

func (v NullableDfsHdfsStat) Get() *DfsHdfsStat {
	return v.value
}

func (v *NullableDfsHdfsStat) Set(val *DfsHdfsStat) {
	v.value = val
	v.isSet = true
}

func (v NullableDfsHdfsStat) IsSet() bool {
	return v.isSet
}

func (v *NullableDfsHdfsStat) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDfsHdfsStat(val *DfsHdfsStat) *NullableDfsHdfsStat {
	return &NullableDfsHdfsStat{value: val, isSet: true}
}

func (v NullableDfsHdfsStat) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDfsHdfsStat) UnmarshalJSON(src []byte) error {
	v.isSet = true
