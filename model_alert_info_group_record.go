...
// checks if the AlertInfoGroupRecord type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AlertInfoGroupRecord{}

// AlertInfoGroupRecord AlertInfoGroupRecord defines the response of alert info group
type AlertInfoGroupRecord struct {
	...
	AlertInfoCount *int64 `json:"alert_info_count,omitempty"`
}
...
// GetAlertInfoCount returns the AlertInfoCount field value if set, zero value otherwise.
func (o *AlertInfoGroupRecord) GetAlertInfoCount() int64 {
	if o == nil || IsNil(o.AlertInfoCount) {
		var ret int64
		return ret
	}
	return *o.AlertInfoCount
}

// GetAlertInfoCountOk returns a tuple with the AlertInfoCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AlertInfoGroupRecord) GetAlertInfoCountOk() (*int64, bool) {
	if o == nil || IsNil(o.AlertInfoCount) {
		return nil, false
	}
	return o.AlertInfoCount, true
}
...
// SetAlertInfoCount gets a reference to the given int64 and assigns it to the AlertInfoCount field.
func (o *AlertInfoGroupRecord) SetAlertInfoCount(v int64) {
	o.AlertInfoCount = &v
}

func (o AlertInfoGroupRecord) MarshalJSON() ([]byte, error) {
...
func (o AlertInfoGroupRecord) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AlertInfoCount) {
		toSerialize["alert_info_count"] = o.AlertInfoCount
	}
	return toSerialize, nil
}

type NullableAlertInfoGroupRecord struct {
	value *AlertInfoGroupRecord
	isSet bool
}

func (v NullableAlertInfoGroupRecord) Get() *AlertInfoGroupRecord {
	return v.value
}

func (v *NullableAlertInfoGroupRecord) Set(val *AlertInfoGroupRecord) {
	v.value = val
	v.isSet = true
}

func (v NullableAlertInfoGroupRecord) IsSet() bool {
	return v.isSet
}

func (v *NullableAlertInfoGroupRecord) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAlertInfoGroupRecord(val *AlertInfoGroupRecord) *NullableAlertInfoGroupRecord {
	return &NullableAlertInfoGroupRecord{value: val, isSet: true}
}

func (v NullableAlertInfoGroupRecord) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAlertInfoGroupRecord) UnmarshalJSON(src []byte) error {
	v.isSet = true
